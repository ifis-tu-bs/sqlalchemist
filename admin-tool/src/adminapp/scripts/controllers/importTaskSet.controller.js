...
angular
    .module('app')
    .controller('importTaskSetController', importTaskSetController);

    importTaskSetController.$inject = ['TaskService', '$scope', 'FlashService'];
    function importTaskSetController(TaskService, $scope, FlashService) {
        var vm = this;
