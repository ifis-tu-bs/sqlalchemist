    ...
    onResetEvent: function() {
        ...
        this.CoinClick = function (difficulty) {
            return function() {
                ...
                $("[id*='taskLevel']").fadeOut(100);
                $("#backFromTrivia").fadeOut(100);
                $("#triviaHeader").fadeOut(100);
                //$("#backgroundTriviaId").fadeOut(100);
                setTimeout( function() {
         ...
         */
         var taskLevel;
        for (var i = 0; i < 3; i++) {
            taskLevel = new game.ClickableElement('taskLevel' + i + 1, '', this.CoinClick(i + 1), 12.5, 21.484375, 21 + i * 23.560606, 26.041667, 1);
        ...
        var backFromTrivia = new game.ClickableElement('backFromTrivia', 'Back', triviaBackClick, 15, 6.5, 42, 81, 1);
