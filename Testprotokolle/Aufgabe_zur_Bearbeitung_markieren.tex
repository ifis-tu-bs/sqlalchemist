...
\hline
\textbf{Testfall} & \textit{Eine Aufgabe zur Bearbeitung markieren\textbf{T100}} \\
\hline
...
\newline
@Test \newline
public void testTaskFile\_rateEdit() \{\newline
...
\hspace*{3mm}task.rateEdit(profile);\newline
\hspace*{3mm}assertEquals(task.getRating().getEditRatings(), 1);\newline
\hspace*{1mm}\} catch (Throwable e) \{ \newline
\hspace*{3mm}testSuccessful = false; \newline 
\hspace*{1mm}\} \newline
\hspace*{1mm}assertTrue(testSuccessful);\newline
\hspace*{1mm}Logger.info("'testTaskFile\_rateEdit successfull"');\newline
\}
} \\
\hline
\textbf{Soll - Reaktion} & \textit{Konsole zeigt Meldung:\newline "'testTaskFile\_rateEdit successfull"'
} \\
\hline
