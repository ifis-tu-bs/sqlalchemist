...
public class ScrollBootstrap {
  ...
  public static void init() {
    Logger.info("Initializing 'Scroll - Recipe' data");
          ...
          ScrollDAO.create(0, "Recipe for the Weak Health Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.HEALTH_POTION, Potion.POWER_LEVEL_1));
          ScrollDAO.create(1, "Recipe for the Moderate Health Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.HEALTH_POTION, Potion.POWER_LEVEL_2));
          ScrollDAO.create(2, "Recipe for the Great Health Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.HEALTH_POTION, Potion.POWER_LEVEL_3));
          ScrollDAO.create(3, "Recipe for the Powerful Health Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.HEALTH_POTION, Potion.POWER_LEVEL_4));
          ScrollDAO.create(4, "Recipe for the Insane Health Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.HEALTH_POTION, Potion.POWER_LEVEL_5));

          ScrollDAO.create(5, "Recipe for the Weak Speed Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.SPEED_POTION, Potion.POWER_LEVEL_1));
          ScrollDAO.create(6, "Recipe for the Moderate Speed Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.SPEED_POTION, Potion.POWER_LEVEL_2));
          ScrollDAO.create(7, "Recipe for the Great Speed Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.SPEED_POTION, Potion.POWER_LEVEL_3));
          ScrollDAO.create(8 ,"Recipe for the Powerful Speed Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.SPEED_POTION, Potion.POWER_LEVEL_4));
          ScrollDAO.create(9, "Recipe for the Insane Speed Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.SPEED_POTION, Potion.POWER_LEVEL_5));

          ScrollDAO.create(10, "Recipe for the Weak Jump Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.JUMP_POTION, Potion.POWER_LEVEL_1));
          ScrollDAO.create(11, "Recipe for the Moderate Jump Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.JUMP_POTION, Potion.POWER_LEVEL_2));
          ScrollDAO.create(12, "Recipe for the Great Jump Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.JUMP_POTION, Potion.POWER_LEVEL_3));
          ScrollDAO.create(13, "Recipe for the Powerful Jump Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.JUMP_POTION, Potion.POWER_LEVEL_4));
          ScrollDAO.create(14, "Recipe for the Insane Jump Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.JUMP_POTION, Potion.POWER_LEVEL_5));

          ScrollDAO.create(15, "Recipe for the Weak Defense Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.DEFENSE_POTION, Potion.POWER_LEVEL_1));
          ScrollDAO.create(16, "Recipe for the Moderate Defense Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.DEFENSE_POTION, Potion.POWER_LEVEL_2));
          ScrollDAO.create(17, "Recipe for the Great Defense Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.DEFENSE_POTION, Potion.POWER_LEVEL_3));
          ScrollDAO.create(18, "Recipe for the Powerful Defense Potion", Scroll.TYPE_RECIPE,
                  PotionDAO.getByTypeAndPowerLevel(Potion.DEFENSE_POTION, Potion.POWER_LEVEL_4));
          ScrollDAO.create(19, "Recipe for the Insane Defense Potion", Scroll.TYPE_RECIPE,
